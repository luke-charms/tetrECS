...
public class GameWindow {
  ...
  /**
   * Display the multiplayer lobby scene
   */
   ...
   *
   * @param game current game played value
   * @param multiPlayerGame boolean multiPlayerGame valuie
   */
  public void startScoresScene(Game game, boolean multiPlayerGame) {
    loadScene(new ScoresScene(this, game, multiPlayerGame, communicator));
  }

  /**
   * Display the multiplayer challenge scene
   *
   * @param users    list of users currently in multiplayer game
   * @param username current user's username
   */
  public void startMultiplayerGame(ObservableList<String> users, String username) {
    loadScene(new MultiplayerScene(this, communicator, users, username));
  }
